            ...
            >
              <div className="mb-3 flex items-start justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {p.input_mode === "book" && (
                    <span className="shrink-0 rounded-full bg-purple-100 px-2 py-0.5 text-[10px] font-medium text-purple-600">
                      书籍
                    </span>
                  )}
                </div>
              ...
              <p className="text-sm text-gray-500">
                当前阶段：{STAGE_LABELS[p.current_stage] || STAGE_LABELS[p.current_stage.split(":")[0]] || p.current_stage}
              </p>
